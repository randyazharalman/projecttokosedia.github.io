    ...
    <div class="container-md  mt-5">
      ...
      <div class="row py-3 mt-5 mx-auto">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
          <figure class="card-product-grid border-label rounded-2 px-2 py-2 justify-content-center mx-auto ">
            <a href="<?=BASEURL;?>products/detail/" type="button" data-bs-toggle="modal" class="img-wrap mb-2 rounded bg-gray-light ">
              ...
              <img height="180" width="200" class="mix-blend-multiply mt-2 mx-auto" src="<?= BASEURL; ?>/img/<?=$data['photo_product']?>">
            </a>
